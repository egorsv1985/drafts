(() => {
  ...
  window.addEventListener("scroll", () => {
    ...
    e <= 0
      ? ue.classList.remove(he)
      : (e > me && !ue.classList.contains(fe)
          ? (ue.classList.remove(he), ue.classList.add(fe))
          : e < me &&
            ue.classList.contains(fe) &&
            (ue.classList.remove(fe), ue.classList.add(he)),
        (me = e));
  });
})();
